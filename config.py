...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/home/lab/eitanshaar/visdrone/visdrone_train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        filter_cfg=dict(filter_empty_gt=True, min_size=0),
        ann_file='/home/lab/eitanshaar/visdrone/visdrone_val.json',
...
val_evaluator = dict(
    ...
    ann_file=data_root + '/home/lab/eitanshaar/visdrone/visdrone_val.json',
    metric='bbox')
